 ...
 **/
exports.deleteSalesOrderHeader = function(id) {
 ...
 * returns List
 **/
exports.getSalesOrderHeader = function() {
  return new Promise(function(resolve, reject) {
    var examples = {};
 ...
 * no response value expected for this operation
 **/
exports.getSalesOrderHeader_0 = function(id) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
...
/**
 *
 * salesOrderHeader SalesOrderHeader  (optional)
 * no response value expected for this operation
 **/
exports.postSalesOrderHeader = function(salesOrderHeader) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
 ...
 * no response value expected for this operation
 **/
exports.putSalesOrderHeader = function(id,salesOrderHeader) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
